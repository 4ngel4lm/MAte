...
export default function MR2() {
  ...
  useEffect(() => {
    const obtenerMaterias = async () => {
      try {
        const response = await fetch('http://10.1.1.33/MateriasPendientes/Phps/Pedir_Recursar.php');
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps='handled'>
        <View style={styles.header}>
          ...
          />
          <Text style={styles.headerText}>Materias a Recursar</Text>
          <Image 
        ...
        <View style={styles.cardContainer}>
          {materia ? (
            <TouchableOpacity style={styles.card}>
              ...
              <Text style={styles.cardText}>Ciclo lectivo para intensificar: 2025</Text>
