      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps='handled'>
        ...
        <View style={styles.cardContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() =>{ 
              if (Iscerrado) {
                Alert.alert('Espera a que el periodo de inscripción esté abierto');
              } else {
                Alert.alert('Inscripción realizada exitosamente');
              }
            }}
          >
            <Text style={styles.botonText}>Inscribirse</Text>
          </TouchableOpacity>
        </View>
